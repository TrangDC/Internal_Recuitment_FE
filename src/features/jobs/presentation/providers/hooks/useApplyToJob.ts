...
import { CandidateJob, NewCandidateJobInput } from 'features/candidatejob/domain/interfaces'
...
function useApplyToJob(props: useApplyToJobProps = { defaultValues: {} }) {
  ...
  >({
    ...
    onSuccess: (data) => {
      const candidateJob: CandidateJob = data[createCandidateJob.operation]?.data;
