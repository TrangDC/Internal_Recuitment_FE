...
export enum ActionApplicationHistoryTabLe {
  DETAIL = 'detail',
  EDIT_CV = 'edit_cv',
  DELETE = 'delete',
...
function useBuildActionApplicationHistory({
  ...
  >({
    actions: {
      ...
      change_status: {
        id: ActionApplicationHistoryTabLe.CHANGE_STATUS,
        onClick: (id, rowData) => {
      ...
      edit_cv: {
        id: ActionApplicationHistoryTabLe.EDIT_CV,
        onClick: (id, rowData) => {
      ...
      copy_application_link: {
        id: ActionApplicationHistoryTabLe.COPY_APPLICATION_LINK,
        onClick: (id, rowData) => {
      ...
      view_cv: {
        id: ActionApplicationHistoryTabLe.VIEW_CV,
        onClick: (_, rowData) => {
      ...
      download: {
        id: ActionApplicationHistoryTabLe.DOWNLOAD,
        onClick: (id, rowData) => {
      ...
      delete: {
        id: ActionApplicationHistoryTabLe.DELETE,
        onClick: (id) => {
          handleOpenDelete(id)
        },
        title: 'Delete',
...
export default useBuildActionApplicationHistory
