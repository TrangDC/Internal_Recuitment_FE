...
function SkillTypePermissionGroup({ roleTemplate }: PermissionGroupProps) {
  ...
  return (
    <CollapseGroup.CollapseContainer
      open={open}
      setOpen={setOpen}
      title={<Text13md color={'grey.900'}>Skill type management</Text13md>}
    >
...
export default SkillTypePermissionGroup
